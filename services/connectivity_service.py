...
class ConnectivityService:
    ...
    async def _check_once(self, client: httpx.AsyncClient) -> None:
        ...
        try:
            ...
            # Il servizio Ollama locale ascolta questo evento e prepara il
            # fallback immediatamente, senza aspettare i 3 healthcheck del
            # debounce. Il routing del gateway resta invece protetto dal
            # FAILURE_THRESHOLD per evitare falsi switch.
